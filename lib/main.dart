...
class fallApp extends StatelessWidget {
  const fallApp({Key? key}) : super(key: key);
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text("GÜNÜN FALI", style: GoogleFonts.robotoMono()),
        ),
        body: falSayfasi(),
      ),
    );
        ...
        children: [
          ...
          Card(
            ...
            child: ListTile(
              ...
              onTap: () {
                setState(() {
                  yanitSayisi = Random().nextInt(5) + 1;
                });
              },
            ),
          ),
          Card(
            ...
            child: ListTile(
              ...
              onTap: () {
                setState(() {
                  yanitSayisi = Random().nextInt(5) + 6;
                });
              },
            ),
          ),
          Card(
            ...
            child: ListTile(
              ...
              onTap: () {
                setState(() {
                  yanitSayisi = Random().nextInt(5) + 11;
                });
              },
            ),
          ),
          Container(
            ...
            child: Padding(
              ...
              child: Text(yanitlar[yanitSayisi],
